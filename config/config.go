...
var (
	...
	SERVER_START_PORT, _     = goconf.AppConf.Int("server.startPort")
	SERVER_VPN_IP            = goconf.AppConf.String("server.VPN.IP")
	SERVER_VPN_START_IP      = goconf.AppConf.String("server.VPN.startIP")
	SERVER_VPN_START_PORT, _ = goconf.AppConf.Int("server.VPN.startPort")
)
